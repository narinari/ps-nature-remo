module NatureRemo.Generation.Emitter where

import Data.HTTP.Method
import Data.Swagger.AST
import Prelude
...
import NatureRemo.Generation.Names (lowercaseFirstChar, startsWith, startsWithUpperCase, typeUnqualifiedName)
...
emitDeclaration (NewtypeDecl (ObjectType {description, fields, qualifiedName})) =
